package io.mosip.kernel.auditmanager.repository.impl;
...
import io.mosip.kernel.auditmanager.constant.HibernateErrorCode;
...
public class AuditHibernateRepositoryImpl<E, T> extends SimpleJpaRepository<E, T> implements BaseRepository<E, T> {
	 ...
	 */
	public AuditHibernateRepositoryImpl(JpaEntityInformation<E, ?> entityInformation, EntityManager entityManager) {
